...
/**
 * A HintsListener is any entity that wants to be notified whenever a mouse or key move by player
 * for a game of reversi.
 */
public interface HintsListener {
  /**
   * Notify the listener (player) that a new move may happen, and provide the hints of possible
   * points earn to player.
